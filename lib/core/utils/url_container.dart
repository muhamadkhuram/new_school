class UrlContainer {
  static const String baseUrl = 'https://newflix.net/';
  ...
  static const String acceptPartyJoinRequestEndPoint =
      'api/party/request/accept';
  static const String rejectPartyJoinRequestEndPoint =
      'api/party/request/reject';
  ...
  static const String dashboardEndPoint = 'api/dashboard';
    static const String liveTelevisionCatEndPoint = 'api/tv-cat';
  ...
  // static const String watchVideoPaidEndPoint = 'api/watch-video?item_id';
 ...
 * 
api/party/create
api/party/room/{code}/{guestId?}
api/party/join/request
api/party/request/accept/{id?}
api/party/request/reject/{id?}
api/party/send/message
api/party/player/setting
api/party/status/{id}
api/party/cancel/{id}
api/party/disabled/{id}
api/party/history
api/party/reload
 * 
**/
