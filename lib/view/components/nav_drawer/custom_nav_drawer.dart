...
class _NavigationDrawerWidgetState extends State<NavigationDrawerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    String? name = Get.find<LoginRepo>()
        ...
        '';
    String? image = Get.find<LoginRepo>()
            .sharedPreferences
                              ...
                              children: [
                                ...
                                if (Get.find<ApiClient>()
                                  ...
                                  buildMenuItem(
                                    context,
                                    item:
                                        NavigationItem.watchPartyHistoryScreen,
  ...
  void showErrorSnackbar() {
    CustomSnackbar.showCustomSnackbar(
        errorList: [MyStrings.guestUserAlert.tr], msg: [], isError: true);
  }
  ...
  void logOutUser() async {
    ...
    if (!status) {
      CustomSnackbar.showCustomSnackbar(
          errorList: [], msg: [MyStrings.youHaveLoggedOut.tr], isError: false);
    }
              ...
              Align(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: /*isGuest? Colors.transparent :*/
                            MyColor.primaryColor350,
                        ...
                        children: [
                          urlImage.isEmpty
                              ...
                              : Container(
                                  decoration: BoxDecoration(
                                      border:
                                          Border.all(color: MyColor.colorWhite),
