                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      ratingAndViewWidget(
                        ...
                        controller.movieDetails.data?.item?.view.toString() ??
                            '0.0',
                        iconSize: 22,
                        ...
                        child: Row(
                          children: [
                            CategoryButton(
                                ...
                                verticalPadding: 5,
                                textSize: 14,
                                color: controller.isTeamShow
                                    ? MyColor.colorWhite
                                    : MyColor.primaryColor,
                                text: MyStrings.description,
                                textColor: controller.isTeamShow
                                    ? MyColor.colorBlack
                                    : MyColor.colorWhite,
                                press: () {
                            ...
                            if (controller.isAuthorized() &&
                                controller.movieDetailsRepo.apiClient
                                    .isWatchPartyEnable()) ...[
                              GestureDetector(
                                onTap: () async {
                                  CustomBottomSheet(
                            ...
                            controller.isAuthorized() &&
                                    controller.showWishlistBtn
                                ? CustomIconButton(
                                    isLoading: controller.wishListLoading
                                        ? true
                                        : false,
                                    press: () {
                                    ...
                                    iconColor: controller.isFavourite
                                        ? Colors.red
                                        : MyColor.colorBlack2,
                                  )
                                : const SizedBox(),
                        ...
                        children: [
                          Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  TeamRow(
                                      firstText: '${MyStrings.director.tr}   :',
                                      secondText: controller.movieDetails.data
                                              ?.item?.team?.director ??
                                          ''),
                                  TeamRow(
                                      firstText: '${MyStrings.producer.tr} :',
                                      secondText: controller.movieDetails.data
                                              ?.item?.team?.producer ??
                                          ''),
                                  TeamRow(
                        ...
                        children: [
                          Padding(
                            ...
                            child: ExpandedTextWidget(
                              text: controller.movieDetails.data?.item
                                      ?.description?.tr ??
                                  '',
                            ),
                          ),
