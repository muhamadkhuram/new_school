...
import '../../../subscribe_plan/fib_paymentScreen.dart';
                ...
                onTap: () async {
                  if (controller.isAuthorized()) {
                    AppDialog().rentItemDialog(
                      context,
                      () {
                        // controller.updateSubscriptionSingle();
                        String? id =
                        ...
                        showFibPaymentBottomSheet(
                          context: context,
                          isSingleitem: true,
                          itemid: controller.movieDetails.data!.item!.id!,
                          amount: double.parse(
                              controller.movieDetails.data!.item!.rentPrice!),
                          userId: int.parse(id!),
                        );
                        //  controller.rentVideo();
                      },
                      msgText:
                          '${controller.movieDetails.data?.item?.rentPeriod} ${MyStrings.days}',
                      imageUrl:
                          '${UrlContainer.baseUrl}${controller.playerAssetPath}${controller.playerImage}',
                    );
                  } else {
                      ...
                      child: Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(MyStrings.purchaseNow.tr.toUpperCase(),
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  '${controller.currencySym} ${CustomValueConverter.twoDecimalPlaceFixedWithoutRounding(
                                    controller.movieDetails.data?.item
                                            ?.rentPrice ??
                                        '0',
                                    precision: 0,
                                  )}',
                                ...
                                Text(
                                  ...
                                  style: mulishLight.copyWith(
                                      color: MyColor.colorWhite, fontSize: 18),
                                  textAlign: TextAlign.center,
                                ),
                              ],
                            ),
