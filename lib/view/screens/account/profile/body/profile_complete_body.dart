...
class ProfileCompleteBody extends StatelessWidget {
  const ProfileCompleteBody({Key? key}) : super(key: key);
                  ...
                  : SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                            ...
                            onChanged: (value) {
                              if (value.isNotEmpty) {
                                controller.removeError(
                                    error: MyStrings.kFirstNameNullError);
                              }
                              if (value.isEmpty) {
                                controller.addError(
                                    error: MyStrings.kFirstNameNullError);
                          ...
                          CountryTextField(
                            press: () {
                              CountryBottomSheet.showProfileCompleteBottomSheet(
                                  context, controller);
                            },
                          ...
                          Visibility(
                            ...
                            child: Column(
                              ...
                              children: [
                                const SizedBox(height: 15),
                                LabelText(
                                    space: 12, text: MyStrings.mobileNumber.tr),
                                Row(
                                  children: [
                                    Container(
                                      height: 57,
