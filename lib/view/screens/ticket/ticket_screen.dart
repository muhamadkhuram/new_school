...
//                                     //changed: Get.toNamed(RouteHelper.ticketDetailsdScreen, arguments: [id, subject]);
//                                   },
//                                   child: Container(
...
//                                               style: mulishRegular.copyWith(fontSize: 10, color: Theme.of(context).textTheme.titleLarge!.color?.withOpacity(0.7)),
//                                             )
//                                           ],
//                                         )
//                                       ],
...
//           callback: () {
//             //changed: Get.toNamed(RouteHelper.newTicketScreen)?.then((value) => {Get.find<SupportController>().getSupportTicket()});
//           },
//         ),
//       );
//     });
