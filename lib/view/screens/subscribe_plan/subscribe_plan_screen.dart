...
import 'package:play_lab/data/controller/payment/PaymentController.dart';
...
import 'package:play_lab/view/screens/subscribe_plan/fib_paymentScreen.dart';
...
class _SubscribePlanScreenState extends State<SubscribePlanScreen> {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 2,
      child: GetBuilder<SubscribePlanController>(
        builder: (controller) => Scaffold(
          ...
          //   bottom: TabBar(
          //     tabs: [
          //       Tab(icon: Icon(Icons.home), text: "Buy plan"),
          //       Tab(icon: Icon(Icons.star), text: "Your Subscription"),
          //     ],
          //   ),
          // ),
          body: Column(
                ...
                child: TabBarView(
                  children: [
                            ...
                            : ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      if (controller.planList[index]
                                                  .inAppProduct !=
                                              null &&
                                          controller.availableInAppPurchase ==
                                              true) {
                                        controller.buyIAPProduct(
                                        ...
                                        showFibPaymentBottomSheet(
                                          ...
                                          amount: double.parse(controller
                                              .planList[index].pricing!),
                                          userId: int.parse(id!),
                                        );

                                        // Get.to(() => (FibPaymentScreen(

                                        //       amount:double.parse(controller.planList[index].pricing!), userId: int.parse(id!),
                                        //     )));
                                      }
                                    },
                                    child: Container(
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    if (controller
                                                      ...
                                                      Text(
                                                        '${CustomValueConverter.twoDecimalPlaceFixedWithoutRounding(controller.planList[index].pricing ?? '0')} ${controller.currency}',
                                                        style: mulishSemiBold
                                                            .copyWith(
                                                                color: MyColor
                                                                    .primaryText,
                    ...
                    SubscriptionStatusScreen(
                      user: Get.find<ProfileController>().model.data!.user!,
                    )
                  ],
                ),
              ),
