                ...
                : SingleChildScrollView(
                    ...
                    child: Row(
                      children: List.generate(
                        controller.recentlyAddedList.length >= 8
                            ? 8
                        ...
                        (index) => GestureDetector(
                          onTap: () {
                            ...
                            // print('${UrlContainer.baseUrl}${controller.recentlyAddedImagePath}/${controller.recentlyAddedList[index].image?.portrait}');
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              children: [
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: CustomNetworkImage(
                                        imageUrl:
                                            '${UrlContainer.baseUrl}${controller.recentlyAddedImagePath}/${controller.recentlyAddedList[index].image?.portrait}',
                                        width: 120,
                                        height: 160,
                                      ),
                                    ).animate().fadeIn(
                                    ...
                                    Text(
                                        controller.recentlyAddedList[index]
                                                .title?.tr ??
                                            '',
                                ...
                                CategoryButton(
                                  text: controller.recentlyAddedList[index]
                                              .version ==
                                          '0'
                                      ? controller.recentlyAddedList[index]
                                                  .isTrailer ==
