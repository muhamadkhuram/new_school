...
class LiveTvDetailsController extends GetxController implements GetxService {
  ...
  void initData(int liveTv) async {
    ...
    if (model.statusCode == 200) {
      LiveTvDetailsResponseModel responseModel =
          LiveTvDetailsResponseModel.fromJson(jsonDecode(model.responseJson));
      if (responseModel.status == 'success' && responseModel.data?.tv != null) {
        ...
        if (responseModel.data?.relatedTv != null &&
            responseModel.data!.relatedTv != []) {
          relatedTvList.clear();
