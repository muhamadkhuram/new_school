  ...
  Future<void> signInWithGoogle() async {
    try {
      ...
      CustomSnackbar.showCustomSnackbar(
          errorList: [e.toString()], isError: true, msg: []);
    }
  ...
  Future socialLoginUser({
    ...
    try {
      ...
      if (responseModel.statusCode == 200) {
        ...
        CustomSnackbar.showCustomSnackbar(
            errorList: [responseModel.message], isError: true, msg: []);
      }
    } catch (e) {
      //printx(e.toString());
    }
...
//
  void checkAndGotoNextStep(LoginResponseModel responseModel) async {
    bool needEmailVerification =
        responseModel.data?.user?.ev.toString() == "0" ? true : false;
