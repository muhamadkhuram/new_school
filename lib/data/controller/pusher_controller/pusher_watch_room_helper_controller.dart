...
class PusherWatchRoomHelperController extends GetxController {
  ...
  Future<Map<String, dynamic>?> onAuthorizer(String channelName, String socketId, options) async {
    try {
      // var authUrl = "http://192.168.30.113/playlab/2.8/api/authenticationApp";
  ...
  void onConnectionStateChange(dynamic currentState, dynamic previousState) async {
    print("on connection state change $previousState $currentState");
  }
  ...
  void onSubscriptionError(String message, dynamic e) {
    print("onSubcription Erro: $isPusherLoading$message");
  }
  ...
  //danger: close pusher channel when back
  void clearData() {
    closePusher();
